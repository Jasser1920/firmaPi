...
class Categorie
{
    ...
    #[Assert\Choice(
        choices: ["Fruits", "Légumes", "Céréales", "Fruits secs", "Apiculture","Oeufs", "Produits laitiers", "Viande", "Volaille","Plantes aromatiques","Plantes médicales", "Champignons","Huiles","Épices"],
